...
function stringTest(randomStr){
  console.log(randomStr.toUpperCase())
} 
 stringTest(sampleString)
...
console.log(emailCheck('aymohamed07@gmail.com'))
...
function chocolateFrogs(budget){
   return budget/3
...
/*
  ...
  that fixes this bug. Invoke the function and store the 
  returned value to a variable called `totalFrogs2`.
*/

//CODE HERE

function chocolateFrogs(budget){
  numberOfFrogs = budget/3
  return Math.floor(numberOfFrogs)

} 
let totalFrogs2 = chocolateFrogs(4)
...
/*
  Write a function that takes in an array of numbers as an argument.
   ...
   ascending order. The function should return true, if it is sorted in ascending order
   , false if it is not. Create a variable, `arrayIsAscending` 
